...
export function ClientMsg(w: e.ObjectWriter, msg: proto.ClientMsg): void {
    w.stringRaw("type", msg.type);
    if (msg.type === "hello") {
        if (msg.jwt !== undefined) { w.string("jwt", msg.jwt); }
...
function Request(w: e.ObjectWriter, msg: proto.Request): void {
    w.stringRaw("type", msg.type);
